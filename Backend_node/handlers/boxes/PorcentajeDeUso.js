...
export const main = async (event) => {
  try {
    ...
    boxesResult.Items.forEach(b => {
      boxesJson[b.idbox] = { libre: true, uso: 0 };
    });

    // Obtener todos los agendamientos de la fecha
    ...
    console.error("Error en PorcentajeDeUso:", err);
