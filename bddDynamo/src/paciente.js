...
const PACIENTETABLE = process.env.TABLE
...
/*
 Ejemplo básico de consulta de todos los documentos
 Por defecto, cada consulta devuelve como máximo 100 registros
 Se debe implementar paginación para obtener todos los resultados
 Como referencia para su implementación
 https://du7.medium.com/paginating-dynamodb-scans-and-queries-easily-using-dynamodb-document-client-example-844b6d1ffc83
*/
